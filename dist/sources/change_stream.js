...
var DEFAULT_BASE_URL = "http://planet.osm.org/replication/minute/";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return axios.get(`${baseURL}state.txt`);

          case 4:
            rsp = _context.sent;
            matches = rsp.data.match(/sequenceNumber=(\d+)/);
            return _context.abrupt("return", parseInt(matches[1], 10));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 5;
            return axios.get(`${baseURL}${path}.osc.gz`, {
              responseType: "stream"
            });
